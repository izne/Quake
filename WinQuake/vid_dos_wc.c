...
WATCOM C++ PORT NOTES:
- Converted DJGPP-specific includes to Watcom equivalents
- Replaced DPMI calls with Watcom DOS4GW compatible functions
- Modified interrupt handling for Watcom syntax
*/
...
// Watcom: Use the existing regs declaration from dosisms.h
// extern regs_t regs; is already declared in dosisms.h
